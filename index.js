...
server.post("/addbook", authmiddleware, authmiddleware2(["viewer","creator"]), async (req, res) => {
    try {
...
server.get("/getbook", authmiddleware, authmiddleware2(["viewer","creator"]), async (req, res) => {
    try {
...
server.put("/updatepro/:_id",authmiddleware, authmiddleware2(["creator"]), async (req, res) => {
    try {
        await Bookmodel.updateOne(req.params,{$set:req.body});
...
server.delete("/deletebook/:_id",authmiddleware, authmiddleware2(["creator"]), async (req, res) => {
    try {
